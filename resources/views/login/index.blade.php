...
@if (session('success'))
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form class="bg-light p-4 rounded shadow" method="POST" action="/login/login">
                    @csrf
                    <!-- Email input -->
                    ...
                    <div class="text-center mb-3">
                        <p class="mb-1">Not a member? <a href="/login/signin" class="text-decoration-none">Register</a></p>
